...
class DeepTraderLSTM: 
    ...
    def __init__(self, input_shape, model_name="DeepTrade_LSTM"):
        ...
        self.model.compile( 
            ...
            metrics=["mae", "msle"] # Additional metrics to track (Mean Absolute Error, Mean Squared Logarithmic Error)
        )
    ...
    def save_model(self): 
        ...
        with open(f"{model_dir}/{self.model_name}.json", "w") as json_file:
            json_file.write(model_json)

        # Save the weights as H5 
        self.model.save_weights(f"{model_dir}/{self.model_name}.weights.h5")
